...
console.log(chalk.bgWhite(chalk.bgWhite("\n              "),chalk.bgBlue.bold("C"),chalk.bgBlueBright.bold("U"),chalk.bgYellow.bold("R"),
chalk.bgGreenBright.bold("R"),chalk.bgMagenta.bold("E"),chalk.bgGray.bold("N"),
chalk.bgYellow.bold("C"),chalk.bgRedBright.bold("Y"), "      ",

chalk.bgBlue.bold("C"),chalk.bgBlueBright.bold("O"),chalk.bgYellow.bold("N"),
chalk.bgGreenBright.bold("V"),chalk.bgMagenta.bold("E"),chalk.bgGray.bold("R"),
chalk.bgYellow.bold("T"),chalk.bgRedBright.bold("E"),chalk.bgMagentaBright.bold("R"),chalk.bgWhite("              ")));
